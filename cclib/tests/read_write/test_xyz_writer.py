...
from cclib.data.data_handler import get_data_path, get_data
...
class XYZWriterTest(unittest.TestCase):
    def test_init(self):
        ...
        fpath = get_data_path("ADF/basicADF2007.01/dvb_gopt.adfout")
    ...
    def test_roundtrip_one(self):
        ...
        """
        orig_fpath = get_data_path("XYZ/uracil.xyz")
        ...
        ref_fpath = get_data_path("XYZ/uracil_one_ref.xyz")
    ...
    def test_roundtrip_two(self):
        ...
        instance then writing it out again.
        """
        orig_fpath = get_data_path("XYZ/uracil_two.xyz")
        reader = cclib.io.xyzreader.XYZ(orig_fpath)
        data = reader.parse()
        ...
        ref_fpath = get_data_path("XYZ/uracil_two_ref.xyz")
        with open(ref_fpath) as ref:
            # Compare the contents of the reference file (left) with
            # the string representation generated by the writer
            # (right).
    ...
    def test_quantum_output_repr(self):
        ...
        output?
        """
        data, _ = get_data("QChem", "basicQChem5.1", ["dvb_sp.out"])
        writer = cclib.io.xyzwriter.XYZ(data)
